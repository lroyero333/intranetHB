...
$(function () {
    ...
    $demoMaskedInput.find('.time12').inputmask('hh:mm t', {
        placeholder: '__:__ _m', alias: 'time12', hourFormat: '12', minTime: '8:00am',
        maxTime: '6:00pm',
    });
    ...
    $demoMaskedInput.find('.datetime12').inputmask('d/m/y h:s', { placeholder: '__/__/____ __:__', alias: "datetime12", hourFormat: '12' });
